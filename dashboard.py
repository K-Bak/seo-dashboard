...
# ---------- Konstanter (Q4) ---------------------------------------------------
YEAR_GOAL = 200_000      # års-mål (2025)
Q4_GOAL   = 100_000      # Q4 (uge 40-51)
YEAR      = 2025
START_UGE = 40
SLUT_UGE  = 51
...
mask_q4   = df["Uge"].between(START_UGE, SLUT_UGE) & mask_year
...
st.markdown("<h1 style='text-align:center;margin-top:-50px;margin-bottom:-80px'>"
            "SEO – Q4</h1>", unsafe_allow_html=True)
...
with col2:
    ...
    with st.columns([0.2, 0.6, 0.2])[1]:
        ...
        # blå bid
        ax2.add_patch(Wedge((0,0), 1, 90, 90 + q4_pct*360,
