...
# Korrekt udtrækning og parsing af tilbudsdata
...
with col1:
    ...
    with inner_cols[1]:
        ...
        # Tilbud ugevis: brug kun rækker med Status == "Tilbud"
        tilbud_ugevis = (
            tilbud_df
            .groupby("Uge")["Pris"]
            .sum()
            .reindex(alle_uger, fill_value=0)
        )
...
produktliste = ["SEO Ai Boost", "Linkbuilding", "Content pakker", "GBP", "Bing Business", "Maps Optimering"]
...
antal_tilbud = aktive_tilbud["Pris"].count()
